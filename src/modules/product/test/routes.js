            ...
            .end(function (err, res) {
                ...
                request(app)
                    ...
                    .end(function (err, res) {
                        ...
                        assert.equal(resp.data.price, item.price);
                        assert.equal(resp.data.shop.name, item.shop.name);
                        assert.equal(resp.data.categories[0].name, item.categories[0].name);
                        done();
                    });
            });
    });
            ...
            .end(function (err, res) {
                ...
                request(app)
                    ...
                    .end(function (err, res) {
                        ...
                        assert.equal(resp.data.price, update.price);
                        assert.equal(resp.data.shop.name, update.shop.name);
                        assert.equal(resp.data.categories[0].name, update.categories[0].name);
                        done();
                    });
            });
    });
